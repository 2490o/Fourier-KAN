...
class FourierKAN(nn.Module):
    """
    Fourier-KAN Feature Recombination Module.
    Based on TIP 2025: Feature Decomposition and Recombination.
    Implements Amplitude/Phase decomposition and Quadratic Polynomial transformation.
    ...
    def __init__(self, c1, L=8):
        ...
        with torch.no_grad():
            ...
            self.amp_params[:, 1].fill_(1.0)  # w1 = 1
            self.amp_params[:, 2].zero_()     # w0 = 0

            # Phase initialization
            self.phase_params[:, 0].zero_()
            self.phase_params[:, 1].fill_(1.0)
            self.phase_params[:, 2].zero_()
